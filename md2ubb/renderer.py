...
class UbbRenderer(object):
    ...
    def codespan(self, text):
        ...
        # return '[b][color=#000000][backcolor=silver]%s[/backcolor][/color][/b]' % text
        # return '[backcolor=silver]%s[/backcolor]' % text
        return '[b][color=#000000]%s[/color][/b]' % text
    ...
    def block_code(self, code, lang=None):
        ...
        if not lang:
            ...
            return '[mw_shl_code=bash,true]%s[/mw_shl_code]\n' % code
        code = escape(code, quote=True, smart_amp=False)
        return '[mw_shl_code=bash,true]%s\n[/mw_shl_code]\n' % code
